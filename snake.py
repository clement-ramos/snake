...
class MAIN:
    ...
    def draw_score(self):
        ...
        score_surface = game_font.render(score_text, True, GRAY)
...
def update_score(username, score):
    with open('score.json', 'r') as file:
        ...
        if not username in user_list:
            user_list[username] = score

        if user_list[username] < score:
...
game_font = pygame.font.Font("assets/GLS.ttf", 32)
